//
//  EventSummaryDecodingTests.swift
//  MarvelAPITest
//
...
class EventSummaryDecodingTests: XCTestCase {
    ...
    func test_testDecoding() {
        ...
        let _ = sut.publisher.decode(type: EventSummary.self, decoder: JSONDecoder()).sink { compl in
            switch compl {
            ...
            XCTAssert(model.resourceURI == "http://gateway.marvel.com/v1/public/events/269")
            XCTAssert(model.name == "Secret Invasion")
            parseExpct.fulfill()
        }
